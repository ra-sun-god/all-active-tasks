...
export const serverConfig: ServerConfig = {
  host: process.env.TASK_2_SERVER_HOST ?? "127.0.0.1",
  port: Number(process.env.TASK_2_SERVER_PORT ?? 3030),
  ...
  corsOrigins: ["http://127.0.0.1:3000","http://localhost:3000", "https://task2.libertypie.com"],
};
